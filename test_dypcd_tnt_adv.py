...
s_all = {'Auditorium':1, 'Ballroom':2, 'Courtroom':2, 'Museum':2, 'Palace':2, 'Temple':2}
conf_all = {'Auditorium':0.01, 'Ballroom':0.01, 'Courtroom':0.01, 'Museum':0.01, 'Palace':0.01, 'Temple':0.01}
dist_all = {'Auditorium':1/1*d_r['Auditorium'], 'Ballroom':1/1*d_r['Ballroom'], 'Courtroom':1/1*d_r['Courtroom'],
            'Museum':1/1.5*d_r['Museum'], 'Palace':1/1*d_r['Palace'], 'Temple':1/1*d_r['Temple']}
