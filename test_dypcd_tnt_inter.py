...
s_all = {'Family':2, 'Francis':4, 'Horse':3, 'Lighthouse':2, 'M60':2, 'Panther':2, 'Playground':3, 'Train':3}
conf_all = {'Family':0.1, 'Francis':0.1, 'Horse':0.05, 'Lighthouse':0.05, 'M60':0.1, 'Panther':0.1, 'Playground':0.1, 'Train':0.1}
dist_all = {'Family':1/1*d_r['Family'], 'Francis':1/1*d_r['Francis'], 'Horse':1/1*d_r['Horse'], 'Lighthouse':1/1*d_r['Lighthouse'],
            'M60':1/4*d_r['M60'], 'Panther':1/4*d_r['Panther'], 'Playground':1/4*d_r['Playground'], 'Train':1/4*d_r['Train']}
