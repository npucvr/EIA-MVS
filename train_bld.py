...
parser.add_argument('--lrepochs', type=str, default="6:8:2", help='epoch ids to downscale lr and the downscale rate')
...
if __name__ == '__main__':
    ...
    if args.dataset.startswith('dtu'):
        ...
        # train_dataset = MVSDataset(args.trainpath, args.trainlist, "train", 7, args.interval_scale, rt=args.rt,  use_raw_train=args.use_raw_train)
        # test_dataset = MVSDataset(args.testpath, args.testlist, "val", 7, args.interval_scale)
